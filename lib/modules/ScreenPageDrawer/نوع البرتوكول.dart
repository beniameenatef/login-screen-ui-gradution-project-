...
class No3Alprotocol extends StatelessWidget {
  const No3Alprotocol({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        ...
        title:Text('نوع البرتوكول',style: TextStyle(fontWeight: FontWeight.bold,
